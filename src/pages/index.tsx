...
const Index = () => {
	...
	return (
		<>
			<Head>
				<title>Ethnus Feedback App</title>
				<meta
					property="og:title"
					content="Ethnus Feedback App"
					key="title"
				/>
				<meta
					property="og:description"
					content="A Ethnus Feedback Application for collecting reviews for a product after a successful purchase."
					key="description"
				/>
			</Head>
			<Navbar />
			<Container maxW="container.xl" py="16" px="5">
				<VStack align="stretch">
					<Text fontSize="sm" fontWeight="semibold">
						Review and Rating Platform, P39
					</Text>
					<Heading fontSize={["4xl", "4xl", "7xl"]}>Leave a Rating</Heading>
					<Text fontSize="xl" fontWeight="light">
						Created by Team 444, under Ethnus Mern Internship
					</Text>
				</VStack>
				<Stack
